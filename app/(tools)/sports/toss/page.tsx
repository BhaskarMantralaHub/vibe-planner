  ...
  return (
    <div className="min-h-[calc(100vh-52px)] flex flex-col items-center px-4 py-6 relative overflow-hidden">
      ...
      <div className="text-center mb-4">
        ...
        <h2 className="text-[24px] lg:text-[32px] font-bold bg-gradient-to-r from-[var(--toolkit)] via-[var(--blue)] to-[var(--toolkit-accent)] bg-clip-text text-transparent">
          Coin Toss
        </h2>
      </div>
      ...
      <button
        ...
        style={{
          background: 'linear-gradient(135deg, var(--toolkit), var(--toolkit-accent))',
          color: '#fff',
