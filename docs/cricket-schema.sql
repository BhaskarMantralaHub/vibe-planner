...
-- ============================================================================
-- ── Cricclubs ingestion (migration 005, applied 2026-05-01) ─────────────────
-- See docs/migrations/005_cricclubs_tables.sql for the canonical migration
-- (with BEGIN/COMMIT envelope). The blocks below mirror that file's content
-- so this schema reference stays the single source of truth for table shape.
-- ============================================================================
...
-- ============================================================================
-- DONE (committed in the same PR as migration 005):
