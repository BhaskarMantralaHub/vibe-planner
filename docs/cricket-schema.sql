...
-- NOTE: This trigger does NOT yet create team_members rows or pass team_id.
-- That will be added in Phase 5. For now, team_members are populated
-- by the AuthGate auto-approve flow on the client side.
